...
<script type="text/javascript" src="../../../js/script.js"></script>
  ...
  <hr />
  <form method="post" action="../controller/schedule.php?action=donor" enctype="multipart/form-data">
  ...
  <tr>
       ...
       <td>&nbsp;
                        ...
                        <div class="ed_frm" style="display:none">
                            <hr />
    <form method="post" 
    action="../controller/schedulecontroller.php?action=add" enctype="multipart/form-data">

         <table width="80%" align="center">
        
  <td>Full Name OR NIC OR Password :</td>
