                   ...
                   <div class="container-fluid">
                       ...
                       <div class="row">
                           ...
                           <div class="col-sm-3 col-md-3 col-lg-3">
                               <input type="text" name="user_fname" id="user_fname" class="input-sm" placeholder="First Name">
                           </div>
                           
                           <div class="col-sm-3 col-md-3 col-lg-3"><h4>Last Name </h4></div>
                           <div class="col-sm-3 col-md-3 col-lg-3">
                               <input type="text" name="user_lname" id="user_lname" class="input-sm" placeholder="Last Name">
                           </div>
                       </div>
                       <!--End of ROW 1-->
                       ...
                       <div class="row">
                           ...
                           <div class="col-sm-3 col-md-3 col-lg-3">
                               <input type="text" name="user_name" id="user_name" class="input-sm" placeholder="User Name" onkeyup="showUserName(this.value)">
                               <br>
                               <div id="showName"></div>
                           ...
                           <div class="col-sm-3 col-md-3 col-lg-3">
                               <input type="text" name="user_email" id="user_email" class="input-sm" placeholder="Email Address">
                           </div>
                       </div>
                       <!--End of ROW 2-->
                       ...
                       <div class="row">
                           ...
                           <div class="col-sm-3 col-md-3 col-lg-3">
                               <input type="date" name="dob" id="dob" class="input-sm" placeholder="DOB">
                           </div>
                       ...
                       <div class="row">
                           ...
                           <div class="col-sm-3 col-md-3 col-lg-3">
                               <input type="text" name="nic" id="nic" class="input-sm" placeholder="NIC">
                           </div>
                       ...
                       <div class="row">
                           ...
                           <div class="col-sm-3 col-md-3 col-lg-3">
                               <img id="img_prev" >
                               <input type="file" name="user_image" id="user_image" class="input-sm" onchange="readURL(this);">
                           </div>
                           
                           <div class="col-sm-3 col-md-3 col-lg-3"><h4>Tel No: </h4></div>
                           <div class="col-sm-3 col-md-3 col-lg-3">
                               <input type="text" name="user_tel_no" id="user_tel_no" class="input-sm" placeholder="Tel No" onkeypress="return onlyNos(event,this)">
                           </div>
                       </div>
                       <!--End of ROW 5-->
                          ...
                          <div class="col-sm-3 col-md-3 col-lg-3"><h4>District </h4></div>
                           <div class="col-sm-3 col-md-3 col-lg-3">
                               <select name="district_id" id="district_id" class="input-sm"
                                   ...
                                   <?php while ($dis = $d->fetch_assoc()){ ?>
                                   
                                   <option value="<?php echo $dis['district_id']; ?>">
