...
<input type="hidden" name="userid" value="1">
    ...
    <input type="hidden" name="cancel_return" value="http://localhost/TBS/new_web/cancel.php">
    <input type="hidden" name="return" value="http://localhost/TBS/new_web/success.php">
