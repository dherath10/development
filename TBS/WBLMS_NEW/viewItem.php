...
<table width="1183" border="0" align="center">
  ...
  <tr bgcolor="#EAE5CE">
    ...
    <table width="932" border="0" align="center">
      <tr>
        <td width="230" class="body_p"><h3>&nbsp;</h3></td>
        <td width="207" class="body_p"><h3>Search Items</h3></td>
        <td width="146">&nbsp;</td>
        <td width="331">&nbsp;</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td><?php if(isset($_REQUEST['msg'])){ 
      ...
      <form name="view" method="post" action="viewItemPro.php">
      <tr>
        <td>&nbsp;</td>
        <td>
        ...
        <td><input type="submit" name="view" id="view" value="View Item" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
