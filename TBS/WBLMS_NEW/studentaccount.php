...
if($_SESSION['userid']!="" && $_SESSION['pass']!="" && $_SESSION['cat']=="Student"){
?>
...
<table width="1183" border="0" align="center">
  ...
  <tr align="center" bgcolor="#B6AD89" class="in">
    <td width="544" align="left" valign="top"><blockquote>
      <h3 class="links_color"><em><?php if ($_SESSION['cat']=='Teacher') { ?><a href="teacheraccount.php" class="links_color">Home</a><?php } if ($_SESSION['cat']=='Student') { ?><a href="studentaccount.php" class="links_color">Home</a><?php } ?></em></h3>
    </blockquote></td>
