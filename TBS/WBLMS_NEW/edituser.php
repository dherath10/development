...
<table width="1183" border="0" align="center">
  ...
  <tr align="center" bgcolor="#B6AD89" class="in">
    ...
    <h4 class="links_color"><em>&nbsp;&nbsp;&nbsp;<?php if($_SESSION['cat']=="Admin"){?><a href="adminpanel.php" class="links_color">Home</a><?php } if($_SESSION['cat']=="Librarian"){?><a href="librarianaccount.php" class="links_color">Home</a><?php  } ?></em> | <em><a href="user management.php" class="links_color">User Management</a></em><?php if($_SESSION['cat']!="Admin") {?> | <em><a href="library item management.php" class="links_color">Library Item Management</a></em> | <em><a href="issue_return_items.php" class="links_color">Issue/Return Items</a></em> | <em><a href="reports.php" class="links_color">Reports</a></em> | <em><a href="online_catalog_search.php" class="links_color">Online Catalog</a></em><?php } ?></h4>
...
<table align="center" width="500" border="0">
  	<tr class="body_p">
    	<th colspan="3"><h3 class="body_p">Edit User</h3></th>
        </tr>
        <tr>
        	<td width="150">&nbsp;</td>
            <td width="150">&nbsp;</td>
...
<table width="1000" border="0">
  ...
  <tr>
    ...
    <td width="79"><a href="editusercon.php?id=<?php echo $row['User_ID']; //Send user id to editusercon.php for editing a particular record ?>" >Edit</a>&nbsp;</td>
  </tr>
  <?php } ?>
</table></span>
<p><span>
