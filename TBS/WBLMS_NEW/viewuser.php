...
if($_SESSION['userid']!="" && $_SESSION['pass']!="" && ($_SESSION['cat']=="Admin" || $_SESSION['cat']=="Librarian" || $_SESSION['cat']=="Library Assistant" )){
...
if(isset($_POST['search'])){
	...
	if($_POST['uid']!="" && $_POST['ufname']==""){
		...
		$result=mysqli_query($con,$sql); //Execute $sql querry
	}
...
<table width="1183" border="0" align="center">
  ...
  <tr align="center" bgcolor="#B6AD89" class="in">
    <td width="854" height="30" align="left" valign="top"><blockquote>
      <h4 class="links_color"><em><?php if($_SESSION['cat']=="Admin"){?><a href="adminpanel.php" class="links_color">Home</a><?php } if($_SESSION['cat']=="Librarian"){?><a href="librarianaccount.php" class="links_color">Home</a><?php  } ?> <?php if($_SESSION['cat']=="Library Assistant"){?><a href="libraryassistant.php" class="links_color">Home</a><?php }?></em> | <?php if($_SESSION['cat']=="Library Assistant"){ ?><a href="user management2.php" class="links_color">User Management</a> <?php } else { ?><em><a href="user management.php" class="links_color">User Management</a></em><?php } ?><?php if($_SESSION['cat']!="Admin"){ ?> |  <em><a href="library item management.php" class="links_color">Library Item Management</a></em> | <em><a href="issue_return_items.php" class="links_color">Issue/Return Items</a></em> | <em><a href="reports.php" class="links_color">Reports</a></em> | <em><a href="online_catalog_search.php" class="links_color">Online Catalog</a></em><?php } ?></h4>
    </blockquote>
    </blockquote></td>
...
<table align="center" width="500" border="0">
  	<tr class="body_p">
    	<th colspan="3"><h3 class="body_p">View User</h3></th>
        </tr>
        <tr>
        	<td width="150">&nbsp;</td>
            <td width="150">&nbsp;</td>
        ...
        <form name="view" action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post" onsubmit="return checkView()">
            ...
            <tr>    
              ...
              <td width="150" height="40" align="center"><a href="#aa"><input type="submit" name="search" id="search" value=" Search " align="middle"/></a></td>
        </tr>
            <tr>
...
<table width="1120" border="0">
  <tr class="body_p">
    <td width="87" height="30">User ID</td>
    <td width="118">Type</td>
    <td width="150">First Name</td>
    <td width="150">Last Name</td>
    <td width="96">Gender</td>
    <td width="199">Email</td>
    <td width="132">Date of Birth</td>
    <td width="154">Registered Date</td>
  </tr>
  <?php while($row=mysqli_fetch_array($result)){ ?>
  <tr class="body_p_justify">
    <td width="87"><?php echo $row['User_ID']; ?>&nbsp;</td>
    <td width="118"><?php echo $row['User_Type_Name']; ?>&nbsp;</td>
    <td width="150"><?php echo $row['First_Name']; ?>&nbsp;</td>
    <td width="150"><?php echo $row['Last_Name']; ?>&nbsp;</td>
    <td width="96"><?php echo $row['Gender']; ?>&nbsp;</td>
    <td width="199"><?php echo $row['Email']; ?>&nbsp;</td>
    <td width="132"><?php echo $row['Date_of_Birth']; ?></td>
    <td width="154"><?php echo $row['Reg_Date'];?>&nbsp;</td>
  </tr>
  <?php } ?>
</table></span>
<p><span>
