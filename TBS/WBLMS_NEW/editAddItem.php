...
$sqlItem="SELECT * FROM item as i, publisher as p, item_type as it, category as c WHERE i.Item_ID='$item_ID' AND i.Publisher_ID=p.Publisher_ID AND i.Item_Type_ID=it.Item_Type_ID AND c.cid=i.cid";
...
<table width="1183" border="0" align="center">
  ...
  <tr bgcolor="#EAE5CE">
    <td colspan="2" align="center"><blockquote>
      <div>
        <h3><a href="addcopy.php" class="links_color">Add Item</a> | <a href="editItemSearch.php" class="links_color">Edit Item</a> | <a href="delItemSearch.php" class="links_color">Delete Item</a> | <span class="links_color"><a href="viewadditems.php?id=<?php echo $item_ID;  ?>">View Item</a></span></h3>
</div>
      ...
      <table width="581" height="1202" border="0">
        ...
        <tr>
          ...
          <td height="35" class="alert"><label for="title"></label>
            <input name="title" type="text" id="title" size="45" value="<?php echo $rowItem['Title']; ?>" disabled="disabled"/>&nbsp;<span id="title1"></span><input type="hidden" name="hid" value="<?php echo $rowItem['Title']; ?>"/>            </td>
        </tr>
        <tr>
          <td height="35" colspan="2">Category</td>
          <td height="35" class="alert"><select name="cat" id="cat" required="required">
            <option value="<?php echo $rowItem['cid']; ?>"><?php echo $rowItem['subcategory']; ?></option>
        ...
        <tr>
          ...
          <td height="35"><span class="body_p">
            <input type="number" name="lending" id="lending" min="0" value="<?php echo $nolend; ?>" onkeypress="return onlyNos1(event,this);"/>
            </span></td>
        </tr>
        <tr>
          <td height="35" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;Reference</td>
          <td height="35" class="body_p"><input type="number" name="reference" id="reference" min="0" value="<?php echo $noref; ?>" onkeypress="return onlyNos1(event,this);"/></td>
        </tr>
        <tr>
          <td height="35" colspan="2">Shelf No</td>
          <td height="35" class="alert"><label for="shelfNo"></label>
            <input type="text" name="shelfNo" id="shelfNo" value="<?php echo $rowItem['shelf']; ?>" disabled="disabled" />&nbsp;<span id="shelfNo1"></span></td>
        </tr>
        <tr>
