...
<table width="1183" border="0" align="center">
  ...
  <tr align="center" bgcolor="#B6AD89" class="in">
    ...
    <td width="329" height="30" align="center" valign="middle"><span class="in1">Welcome <a href="myProfile.php" class="body_p"> <?php echo $_SESSION['fname']."-".$_SESSION['cat']; ?></a> | <a href="signout.php">Logout</a> </span></td>
  </tr>
  <tr bgcolor="#EAE5CE">
    <td colspan="2" align="center"><p>&nbsp;</p>
      ...
      <table width="810" border="0">
        <tr>
          <td width="155" align="center"><a href="user management2.php"><img src="Images/Users-Image.png" width="128" height="128" align="middle" /></a></td>
          <td width="41">&nbsp;</td>
        ...
        <tr>
          <td align="center"><a href="user management2.php"><img src="Images/User management2.png" width="126" height="49" align="middle" /></a></td>
          <td>&nbsp;</td>
