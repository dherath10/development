...
<table width="1183" border="0" align="center">
  ...
  <tr bgcolor="#EAE5CE" class="in">
    ...
    <table width="932" border="0" align="center">
      <tr>
        <td colspan="4" align="center" class="body_p"><h3>Search Items for Editing</h3>          </td>
        </tr><form name="view" method="post" action="editItemPro.php">
      <tr>
        <td width="314">&nbsp;</td>
        <td width="120">
        ...
        <td width="213"><input type="submit" name="edit" id="edit" value="Edit Item" /></td>
      </tr>
      <tr>
    ...
    <table border="0" align="center" width="900">
      ...
      <?php do { ?>
        <tr>
          ...
          <td align="center"><a href="editItemDetails.php?id=<?php echo $row_Record['Item_ID'];  ?>">Edit</a> </td>
        </tr>
