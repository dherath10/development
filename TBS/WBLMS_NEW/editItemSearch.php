...
<table width="1183" border="0" align="center">
  ...
  <tr bgcolor="#EAE5CE">
    ...
    <table width="875" border="0" align="center">
      <tr>
        <td>&nbsp;</td>
        <td colspan="2" class="body_p"><strong>Edit Item</strong></td>
        <td>&nbsp;</td>
      </tr>
      <tr>
        <td width="252">&nbsp;</td>
        <td width="185"><?php if(isset($_REQUEST['msg'])){ 
      ...
      <form name="view" method="post" action="editItemPro.php">
      <tr>
        <td align="center" class="body_p"><strong>Search Items</strong></td>
        <td>
        ...
        <td align="center"><span id="items"><input type="text" name="search" id="search" /></span></td>
        <td><input type="submit" name="edit" id="edit" value="Edit Item" /></td>
      </tr>
      <tr>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
      ...
      <tr>
        <td height="160" colspan="4" class="alert">&nbsp;       </td>
        </tr>
    </table>
    <p>&nbsp;</p></td>
  </tr>
