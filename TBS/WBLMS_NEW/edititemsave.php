...
//To Update Items 
$sql="UPDATE `item` SET Publisher_ID='$pubid',Call_No='$_POST[callNo]',Title='$title',Publ_Date='$publDate',Publ_Place='$_POST[publPlace]',Edition='$_POST[edition]',Remarks='$_POST[remarks]',cid='$_POST[cat]' WHERE Item_ID='$iid'";
//Execute $sql query
...
if(($_FILES['photo']['name'])!=""){
	...
	//To detele copies
		$sqldelcopy="DELETE FROM `copy` WHERE Item_ID='$iid'";
		//Execute the query
		mysqli_query($con,$sqldelcopy);
	
//Leanding and Reference .......
	...
	if($typeid==3){
			...
			//To check whether author is existing or not
				...
				if($no==1){
					...
					$rowau=mysqli_fetch_array($resultau);
					$auid=$rowau['Author_ID'];
	$sqlbk1="INSERT INTO serial VALUES('$iid','$auid','$_POST[issn]','$_POST[pages1]')";	
