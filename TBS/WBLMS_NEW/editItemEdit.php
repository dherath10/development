...
<table width="1183" border="0" align="center">
  ...
  <tr bgcolor="#EAE5CE">
    <td colspan="2" align="center"><blockquote>
      ...
      <form action="edititemeditsave.php?id1=<?php echo $item_ID; ?>&id=<?php echo $itype; ?>" method="post" enctype="multipart/form-data" name="addItem" id="addItem" onsubmit="return checkVali()">
      <table width="581" height="1202" border="0">
        ...
        <tr>
          ...
          <td height="35"><span class="body_p">
            <input type="number" name="lending" id="lending" min="0" value="<?php echo $nolend; ?>" disabled="disabled" />
            </span></td>
        </tr>
        <tr>
          <td height="35" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;Reference</td>
          <td height="35" class="body_p"><input type="number" name="reference" id="reference" min="0" value="<?php echo $noref; ?>" disabled="disabled" /></td>
        </tr>
        <tr>
