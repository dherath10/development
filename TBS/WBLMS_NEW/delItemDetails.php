    ...
    <td colspan="2" align="center"><blockquote><br />
      <table width="925" border="0">
        <tr>
          ...
          <td width="276" rowspan="9" align="justify" valign="Top" ><p style="margin:25px"><?php echo $row['Remarks']; ?></p></td>
          <td width="153"><strong>Title:</strong></td>
          <td width="270"><h3><span class="body_p"><?php echo $row['Title']; ?></span></h3></td>
          </tr>
        <tr>
        ...
        <tr>
          <td height="25" colspan="4" align="center"><label>
            <a href="delItem.php?id=<?php echo $iid; ?>"><input type="button" name="del" id="del" value="Delete" onclick="return confirmDelete()" /></a>
            </label></td>
        </tr>
        <tr>
          <td height="119" colspan="4" align="center"><p>&nbsp;</p>
            <table width="600">
            <tr class="in">
          ...
          while($rowc=mysqli_fetch_array($resultc))
            ...
            <tr class="in">
              ...
              <td bgcolor="#FFFFFF"><a href="delCopy.php?id=<?php echo $iid; ?>&acc=<?php echo $rowc['Accession_No']; ?>" onclick="return confirmDelete()">Delete</a>&nbsp;</td>
            </tr>
            <?php } ?>
          </table>            <br />
            <?php 
			//To display the message: successfully deleted accession No
