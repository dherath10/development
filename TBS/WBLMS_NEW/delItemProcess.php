...
<title>Search Items for Editing</title>
<style type="text/css">
...
<table width="1183" border="0" align="center">
  ...
  <tr align="center" bgcolor="#B6AD89" class="in">
    ...
    <td width="330" align="right" valign="middle"><span class="in1">Welcome <?php echo $_SESSION['fname']."-".$_SESSION['cat']; ?> | <a href="signout.php">Logout </a></span></td>
  </tr>
  <tr bgcolor="#EAE5CE" class="in">
    ...
    <table width="932" border="0" align="center">
      <tr>
        <td colspan="4" align="center" class="body_p"><h3><a href="delItemSearch.php" class="links_color">Delete Item</a></h3>&nbsp;</td>
      </tr>
      <tr>
        <td colspan="4" align="center" class="body_p"><h3>Search Items for Deleting</h3>          </td>
        </tr><form name="view" method="post" action="delItemPro.php">
      <tr>
        <td width="314">&nbsp;</td>
        <td width="120">
        ...
        <td width="213"><input type="submit" name="search1" id="search1" value="Search Item" /></td>
      </tr>
      <tr>
    ...
    <table border="0" align="center" width="900">
      ...
      <?php do { ?>
        <tr>
          ...
          <td align="center"><a href="delItemDetails.php?id=<?php echo $row_Record['Item_ID'];  ?>">Delete <br />Item or Copy</a> </td>
        </tr>
