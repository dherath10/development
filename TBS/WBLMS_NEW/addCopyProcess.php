...
<table width="1183" border="0" align="center">
  ...
  <tr align="center" bgcolor="#B6AD89" class="in">
    <td width="853" align="left" valign="top"><blockquote>
    ...
    <td width="330" align="right" valign="middle"><span class="in1">Welcome <?php echo $_SESSION['fname']."-".$_SESSION['cat']; ?> | <a href="signout.php" class="in1"> Logout</a>&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
  </tr>
  <tr bgcolor="#EAE5CE">
    <td colspan="2" align="center"><blockquote>
    <br />
      <h4 class="body_p"><strong>Add a New Copy to the Library</strong></h4>
...
&nbsp;
<form action="addCopySave.php?id1=<?php echo $item; ?>&pubd=<?php echo $pubd; ?>" method="post" enctype="multipart/form-data" name="addItem" id="addItem" onsubmit="return checkVali()">
<table width="653" border="0">
        <tr>
          <td width="251" height="35">Purchased Date</td>
          <td width="392" height="35"><label for="purchasedDate"></label>
            ...
            <span id="day">
              ...
              </span> <span class="alert1">*First Select Year </span></td>
        </tr>
        <tr>
          <td height="35">Donations</td>
          <td height="35"><input type="checkbox" name="donate" id="donate" onclick="enableDisable(this.checked,'currency','price')">&nbsp;</td>
        </tr>
        <tr>
          ...
          <td height="35"><label for="price"></label>
            <select name="currency" id="currency">
              ...
              <?php if(isset($_REQUEST['msg'])){
					?>
                    <option value="<?php echo $_SESSION['currency'] ?>"><?php echo $_SESSION['currency'] ?></option>
                    <?php
            ...
            &nbsp;<input type="number" name="price" id="price" min="0" value="<?php if(isset($_REQUEST['msg'])){
					echo $_SESSION['price']; }
				?>" onKeyPress="return onlyNos(event,this);"/>&nbsp;<span id="price1"></span></td>
        </tr>
        <tr>
          <td>No of Copies:</td>
        ...
        <tr>
          ...
          <td height="35"><span class="body_p">
            <input type="number" name="lending" id="lending" min="0" value="<?php if(isset($_REQUEST['msg'])){
					echo $_SESSION['lending']; }
				?>" onKeyPress="return onlyNos1(event,this);" />
          </span></td>
        </tr>
        <tr>
          <td height="35">&nbsp;&nbsp;&nbsp;&nbsp;Reference</td>
          <td height="35" class="body_p"><input type="number" name="reference" id="reference" min="0" 
          value="<?php if(isset($_REQUEST['msg'])){
					echo $_SESSION['reference']; }
				?>" onKeyPress="return onlyNos1(event,this);" /></td>
        </tr>
        <tr>
          <td height="35">Shelf No</td>
          <td height="35" class="alert"><label for="shelfNo"></label>
            <input type="text" name="shelfNo" id="shelfNo" value="<?php if(isset($_REQUEST['msg'])){
					echo $_SESSION['shelf']; }
				?>" />&nbsp;<span id="shelfNo1"></span></td>
        </tr>
        <tr>
          <td height="35">&nbsp;</td>
