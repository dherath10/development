...
$statarr=array("Available","Not Available","Damaged","Discarded","Lost");
...
$item=$_REQUEST['id'];
$acc=$_REQUEST['acc'];
$sqlacc="SELECT * FROM copy WHERE Accession_No='$acc'";
$resultacc=mysqli_query($con,$sqlacc);
$rowacc=mysqli_fetch_array($resultacc);

$purArray=explode("-",$rowacc['Purchased_Date']);
$pr=explode(" ",$rowacc['Price']);
...
<title>Edit Copy Accession</title>
...
<table width="1183" border="0" align="center">
  ...
  <tr bgcolor="#EAE5CE">
    <td colspan="2" align="center"><blockquote>
      <div>
        <h3><span class="links_color"><a href="editItemSearch.php">Edit Item</a></span></h3>
</div>
<table width="700" border="0">
 ...
 ?>
  ...
  <?php 
      ...
      <form action="editCopyAccSave.php?id1=<?php echo $item; ?>&acc=<?php echo $acc; ?>" method="post" enctype="multipart/form-data" name="addItem" id="addItem" onsubmit="return checkVali()">
      <table width="581" border="0">
        <tr>
          <th height="36" colspan="2" align="center" scope="col"><blockquote>
            <h3>Edit a Copy from the Library</h3>
          </blockquote></th>
          </tr>
        <tr>
          <td colspan="2" align="center" class="alert">
          <?php
        ...
        <tr>
          <td width="250">Accession No</td>
          <td width="317"><?PHP echo $acc; ?>&nbsp;</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td height="35" class="body_p"><label>
        ...
        <tr>
          ...
          <td height="35" class="alert"><label for="shelfNo"></label>
            <input type="text" name="shelfNo" id="shelfNo" value="<?php echo $rowacc['Shelf_No']; ?>" />&nbsp;<span id="shelfNo1"></span></td>
        </tr>
        <tr>
          <td height="35">Status</td>
          <td height="35" class="alert">
            <select name="status" id="status">
            <option value="<?php echo $rowacc['Availability']; ?>" selected="selected"><?php echo $rowacc['Availability']; ?></option>
            <?php foreach($statarr as $e){ 
			if($e==$rowacc['Availability']){
