...
$obj=new stock();
$result=$obj->viewAllStockBalance();
    ...
    <body onload="focusSearch()">
     ...
     <a href="../../login/view/dashboard.php">               
         ...
         <li class="active">
             ...
             <li class="active">
             <a href="../view/stocklevel.php">
             Stock level
             </a></li>
                    </ol> 
    <h3 align="center">Stock Level <small>Management</small></h3>
                ...
                <div class="row" style="padding-left: 20px">
                        <div class="col-lg-6 col-sm-6 col-md-6">  
                            <?php if($userinfo['role_id']==2 || $userinfo['role_id']==3 || $userinfo['role_id']==5){
                             ...
                             <a href="../../stock/view/stocklevel.php">
                ...
                <div class="container-fluid" style="padding-left: 100px;padding-right: 100px">
                    ...
                    <?php while($row=$result->fetch_assoc()){ 
                        ...
                        $size_id=$row['size_id'];
                        $sq=$row['sq'];
              $resultorder=$obj->viewStockBalance($p_id,$size_id);
              $roworder=$resultorder->fetch_assoc();
                        $cq=$roworder['cq'];
                        $bal=$sq-$cq;
                  $resultproduct=$obj->viewProduct($p_id);  
                  $rowproduct=$resultproduct->fetch_assoc();
                        
                        ?>
                    <tr <?php if($bal<=5){ ?> class="alert alert-danger" <?php } ?> >
                            <td width="10%"><img src="../../../images/product_images/<?php  echo $rowproduct['p_image'] ?>"
                                height="35" width="auto" /> </td>
                            <td width="5%"><?php echo $row['p_id']; ?></td>
                            <td width="25%"><?php echo $rowproduct['p_name']; ?></td>
                            <td width="10%"><?php echo $row['size_id']; ?></td>
                           
                            <td width="10%"><?php echo $bal; ?></td>
