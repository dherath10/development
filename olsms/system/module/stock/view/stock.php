    ...
    <h3 align="center">Stock <small>Management</small></h3>
                ...
                <div class="row" style="padding-left: 20px">
                        <div class="col-lg-6 col-sm-6 col-md-6">  
                            <?php if($userinfo['role_id']==2 || $userinfo['role_id']==3 || $userinfo['role_id']==5){
                                ...
                                ?>
                            <a href="../../stock/view/addstock.php?id=0">
                ...
                <div class="container-fluid" style="padding-left: 100px;padding-right: 100px">
                    ...
                    <tr>
                            ...
                            <td width="5%"><?php echo $row['stock_id']; ?></td>
                            <td width="25%"><?php echo $row['p_name']; ?></td>
                            <td width="10%"><?php echo $row['stock_qua']; ?></td>
                            <td width="20%"><?php echo $row['sup_name']; ?></td>
                            <td width="10%"><?php echo $row['size_code']; ?></td>
                            <td width="20%">
<a href="../view/viewstock.php?stock_id=<?php echo $row['stock_id'] ?>&action=view">
    <button class="btn btn-success btn-sm">View</button>
</a>

           &nbsp;
<a href="../controller/stockcontroller.php?stock_id=<?php echo $row['stock_id'] ?>&action=delete">
