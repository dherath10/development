...
--
-- Host: localhost
-- Generation Time: Sep 04, 2016 at 01:55 ප.ව.
...
(1, 10, '2016-09-03', 0, 9, 9, 'Active', 2, '', 2),
(2, 10, '2016-09-03', 0, 9, 9, 'Active', 2, '', 2);
...
--
ALTER TABLE `log`
  MODIFY `log_id` int(200) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=76;
--
