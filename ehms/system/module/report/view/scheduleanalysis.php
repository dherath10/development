    ...
    <body>
        <div id="newmain">
         ...
         <ol class="breadcrumb">
            ...
            <li class="active">Schedule Analysis </li>
</ol>
         
          <!-- To End the path -->          
                    <!-- Header -->

                    <h3 class="pa">Schedule  <small>Analysis</small></h3>

                    <div class="container-fluid">
                        <hr/>
           <form action="scheduleanalysisbytype.php" method="post"<
                        <h4><b>Schedule :</b> From 
        <input type="date" name="from" required class="input-sm"
               ...
               />
                        ...
                        To :
      <span id="too">  
          <input type="date" name="to" required class="input-sm" />
      </span>
