...
include '../model/inquirymodel.php';
$obj=new inquiry();
$result=$obj->viewInquiry();
...
<html>
  ...
  <link href="../../../css/webdashboard.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        <div id="newmain">
         ...
         <ol class="breadcrumb">
            ...
            <li class="active">Inquiry Management</li>
</ol>
         
          <!-- To End the path -->          
                    <!-- Header -->

                    <h3 class="pa">Inquiry <small>Management</small></h3>
