    ...
    if(document.getElementById('uname').value==""){
        ...
        <div id="navi">
            ...
            <div id="contents">
                ...
                <div class="container">
                    <h4> Make Donation </h4>
                    <form action="donationprocess.php" method="post">
                        <div class="row">
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-2">&nbsp;</div>
                             <div class="col-md-2">Donor Emaill:&nbsp;</div>
                              <div class="col-md-6">
                                  <input type="text" name="demail" id="demail" 
               placeholder="Donor Email" class="form-control" />&nbsp;</div>                                            
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-2">&nbsp;</div>
                             <div class="col-md-2">Donor TelNo:&nbsp;</div>
                              <div class="col-md-6">
                                  <input type="text" name="dtelno" id="dtelno" 
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-2">&nbsp;</div>
                             <div class="col-md-2">&nbsp;</div>
                              <div class="col-md-6">
                                  <button type="submit" 
                      class="btn btn-primary">Make Donation</button>
