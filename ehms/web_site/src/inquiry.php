    ...
    if(document.getElementById('uname').value==""){
        ...
        <div id="navi">
            ...
            <div id="contents">
                ...
                <div class="container">
                    <h4>Inquiry</h4>
                    <form method="post" action="inquiryprocess.php">
                    <table class="table">
                        <tr>
                            <th>Name</th>
                            <td>
                        ...
                        <tr>
                            <th>Message</th>
                            <td colspan="3">
                                <textarea name="msg" id="msg" required="" class="form-control"></textarea></td>
                          
                        </tr>
                        <tr>
                            <th>
                                <button name="inquire" type="submit" 
                                        class="btn btn-primary">Inquire</button></th>
                            <td colspan="3">&nbsp;
                                </td>
