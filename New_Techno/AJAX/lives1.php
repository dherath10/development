...
function searchSuggest() {
 if (searchReq.readyState == 4 || searchReq.readyState == 0) {
  var str = escape(document.getElementById('livesearch').value);
  searchReq.open("GET", 'livesearch.php?q=' + str, true);
...
function handleSearchSuggest() {
 if (searchReq.readyState == 4) {
  ...
  var str1 = document.getElementById('livesearch');
  var curLeft=0;
  ...
  var str2 = document.getElementById('livesearch');
  var curTop=20;
...
function setSearch(value) {
 document.getElementById('livesearch').value = value;
...
<form>
<input type="text" size="30" onKeyUp="getXmlHttpRequestObject(this.value)">
